# -*- coding: utf-8 -*-
#
# scapy Library for Topology documentation build configuration file.
#
...
project = 'scapy Library for Topology'
...
htmlhelp_basename = 'topology_lib_scapydoc'
...
latex_documents = [
    (
        'index', 'topology_lib_scapy.tex',
        'scapy Library for Topology Documentation',
