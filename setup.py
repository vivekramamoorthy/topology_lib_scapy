...
setup(
    name='topology_lib_scapy',
    version=find_version('lib/topology_lib_scapy/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_scapy/tree/master/doc',
    keywords='topology_lib_scapy',
    ...
    entry_points={
        'topology_library_10': [
            'scapy = topology_lib_scapy.library'
        ]
    }
)
